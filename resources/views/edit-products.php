<?php include('header.php'); ?>
  ...
  <div id="content-wrapper">
    ...
    <div class="row">
      ...
      <form action="/product/<?php echo $product->id; ?>" class="panel form-horizontal" method="POST">
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group no-margin-hr">
                  ...
                  <input type="text" name="video_id" class="form-control" value="<?php echo $product->video_id; ?>">
                </div>
              </div><!-- col-sm-4 -->
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group no-margin-hr">
                  ...
                  <select name="category_id" class="form-control">
                    <?php foreach($categories as $category) { ?>
                      <option value="<?php echo $category->id; ?>" <?php echo ($product->category_id == $category->id) ? 'selected' : ''; ?>><?php echo $category->category; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div><!-- col-sm-3 -->
              ...
              <div class="col-sm-3">
                <div class="form-group no-margin-hr">
                  ...
                  <input type="number" name="quantity" class="form-control" value="<?php echo $product->price; ?>">
                </div>
              </div><!-- col-sm-3 -->
              ...
              <div class="col-sm-3">
                <div class="form-group no-margin-hr">
                  ...
                  <input type="number" name="warranty" class="form-control" value="<?php echo $product->warranty; ?>">
                </div>
              </div><!-- col-sm-3 -->
            </div><!-- row -->
